...
import type { InstructorLearningRecord } from "@/features/instructor-learning-records/types";
...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  try {
    const result = await authenticatedBackendRequest<InstructorLearningRecord>(
      request,
      `/me/course-offerings/${course_offering_id}/learning-records/${learning_record_id}`,
      {
        method: "GET",
      },
    );
    ...
    console.error("ATLAS instructor learning-record request failed:", error);
