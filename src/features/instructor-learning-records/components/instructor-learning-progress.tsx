      ...
      <CardHeader>
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            Concept mastery across configured learning objectives and SOLO
            levels.
          </p>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        {progress.learning_objectives.length === 0 ? (
          <div className="rounded-lg border border-dashed p-6 text-center">
            <p className="font-medium">No curriculum progress available</p>

            <p className="mt-1 text-sm text-muted-foreground">
              This learning record does not currently contain configured
