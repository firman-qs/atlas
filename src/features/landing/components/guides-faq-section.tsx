            ...
            <Card className="flex h-full flex-col justify-between border border-border/80 bg-card/75 shadow-xs backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:shadow-md">
              ...
              <CardContent className="p-6">
                <div
                  ...
                  className="group cursor-pointer flex flex-col items-center justify-center rounded-xl border border-dashed p-8 text-center bg-muted/40 backdrop-blur-xs hover:bg-muted/60 transition-colors"
                >
                  ...
                  {videoModalOpen && (
                    <div className="mt-4 rounded-lg bg-background/90 backdrop-blur-xs p-3 text-xs sm:text-sm text-primary font-medium border border-primary/20 animate-in fade-in">
                      {t("video.modalText")}
                    </div>
                  )}
                </div>
